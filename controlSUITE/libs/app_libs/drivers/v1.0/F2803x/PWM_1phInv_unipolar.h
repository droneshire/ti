...
//
//-------------------------------------------------------------------------------------
#ifndef _PWM_1phInv_unipolar_H_
#define _PWM_1phInv_unipolar_H_
...
#define PWMDRV_1phInv_unipolar(n,p,v) 							\
	...
	{																					\
		...
		(*ePWM[n+1]).CMPA.half.CMPA	= _IQ15mpy(p,_IQtoIQ15(_IQ24abs(v)))>>15;			\
	}																					\
	else																				\
	{																					\
		(*ePWM[n]).CMPA.half.CMPA	= _IQ15mpy(p,_IQtoIQ15(_IQ24abs(v)))>>15;	\
