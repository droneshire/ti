...
-------------------------------------------------------------------------------------
 ...
 This Hall drive use GPIOs only for Piccolo instead of eCAP
-----------------------------------------------------------------------------------*/

#ifndef __F2805X_HALL3_GPIO_H__
#define __F2805X_HALL3_GPIO_H__
...
/*------------------------------------------------------------------------------
Default Initializer for the F2805X HALL3 Object
------------------------------------------------------------------------------*/
#define F2805XHALL3      {0,  \
                          0,  \
                          0,  \
                         10,  \
                          0,  \
...
------------------------------------------------------------------------------*/
#define HALL3_DEFAULTS F2805XHALL3
...
#define HALL3_DETERMINE_STATE_MACRO(v)														\
	...
	HallGpioBitA = HallGpioBitA;															\
	HallGpioBitB = HallGpioBitB<<1;															\
	HallGpioBitC = HallGpioBitC<<2;															\
																							\
