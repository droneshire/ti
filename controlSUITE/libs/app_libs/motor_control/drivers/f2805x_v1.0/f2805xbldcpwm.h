...
#ifndef __F2805X_BLDCPWM_H__
#define __F2805X_BLDCPWM_H__
...
/*----------------------------------------------------------------------------
Initialization constant for the F2805X Dead-Band Control Generator register.
----------------------------------------------------------------------------*/
...
------------------------------------------------------------------------------*/
#define F2805X_BLDC_PWM_GEN   { 0x0000, \
                                0x7FFF, \
                                0x1D4C, \
                                0x0000, \
                                0x0001, \
                              } 
#define PWMGEN_DEFAULTS 	F2805X_BLDC_PWM_GEN
/*------------------------------------------------------------------------------
	F2805XBLDCPWM Macro Definitions
------------------------------------------------------------------------------*/
...
//Make sure that the GPIO configuration is properly done in ...-DevInit_F2805x.c, like shown below\
