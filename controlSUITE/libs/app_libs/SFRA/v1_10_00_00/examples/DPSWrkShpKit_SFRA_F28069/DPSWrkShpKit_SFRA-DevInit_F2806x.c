...
// 0x2 =  10	MHz		(2)
   ...
   PLLset( 0x10 );	// choose from options above => 20Mhz
...
// Refer to the datasheet for your particular device. 
   ...
   //------------------------------------------------
   SysCtrlRegs.PCLKCR1.bit.ECAP1ENCLK = 1;	//ECAP-1
...
//	GpioDataRegs.GPACLEAR.bit.GPIO7 = 0;	// uncomment if --> Set Low initially
...
//--------------------------------------------------------------------------------------
//--------------------------------------------------------------------------------------
//  GPIO-16 - PIN FUNCTION = TZ3
	GpioCtrlRegs.GPAMUX2.bit.GPIO16 = 3;	// 0=GPIO, 1=SPISIMOA, 2=Resv, 3=TZ2n
...
//  GPIO-19 - PIN FUNCTION
	GpioCtrlRegs.GPAMUX2.bit.GPIO19 = 3;	// 0=GPIO, 1=SPISTEA, 2=SCIRXDB, 3=ECAP1
