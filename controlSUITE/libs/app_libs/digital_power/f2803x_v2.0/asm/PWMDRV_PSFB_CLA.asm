...
_PWMDRV_PSFB_CLA_Start:n:
		...
		MUI32TOF32 MR1,  *MAR0							;Load the phase input value into MR1 and convert it to float
		MMOV16 MAR0, @_PWMDRV_PSFB_CLA_DbLeft:n:		; Net pointer for dbLeft (MAR0)			
		MMPYF32    MR1,  MR1,  #1.0L/33554432.0L 		; Note the input is scaled by 1/2 to calculate (input*Period/2) as maximum phase shift is Period/2
