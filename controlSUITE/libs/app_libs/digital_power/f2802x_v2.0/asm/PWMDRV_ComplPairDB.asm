...
_PWMDRV_ComplPairDB_In:n:			.usect "PWMDRV_ComplPairDB_Section",2,1,1	; input terminal
...
;=============================
	   MOVW 	DP, #_PWMDRV_ComplPairDB_In:n:                ; load DP for net pointer
       MOVL   	XAR0, @_PWMDRV_ComplPairDB_In:n:              ; Load net pointer address to XAR0
...
;-------------------------------------------------------------------------------------------
;=============================
PWMDRV_ComplPairDB_Update	.macro	n
;=============================
	   MOVW 	DP, #_PWMDRV_ComplPairDB_In:n:                ; load DP for net pointer
