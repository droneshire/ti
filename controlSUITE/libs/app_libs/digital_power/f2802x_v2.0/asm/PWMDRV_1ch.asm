...
PWMDRV_1ch	.macro	n
;=============================
	   MOVW 	DP, #_PWMDRV_1ch_In:n:                ; load DP for net pointer
       MOVL   	XAR0, @_PWMDRV_1ch_In:n:              ; Load net pointer address to XAR0
