;------------------------------------------------------------------------------
;	FILE:			PWMDRV_ComplPairDB_CLA.asm
;
...
_PWMDRV_ComplPairDB_CLA_Duty:n:			.usect "PWMDRV_ComplPairDB_CLA_Section",2,1,1	; input terminal
...
;===========================================================
        .def 	_PWMDRV_ComplPairDB_CLA_Duty:n:
        ...
        MOVW	DP, #_PWMDRV_ComplPairDB_CLA_Duty:n:
        MOVL	@_PWMDRV_ComplPairDB_CLA_Duty:n:, XAR2
...
_PWMDRV_ComplPairDB_CLA_DRV_Start:n:
        ...
        ;              
        MMOV16      MAR0, @_PWMDRV_ComplPairDB_CLA_Duty:n:
