...
;=============================
	   ...
	   MOVW 	DP, #_PWMDRV_1chHiRes_Duty:n:                ; load DP for net pointer
       MOVL   	XAR0, @_PWMDRV_1chHiRes_Duty:n:              ; Load net pointer address to XAR0
