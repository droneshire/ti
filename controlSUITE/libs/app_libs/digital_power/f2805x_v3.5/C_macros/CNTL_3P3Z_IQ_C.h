 ...
 * This macro uses CNTL_3P3Z_IQ_C structures to store coefficients & internal values.
 * The structures should be initialized with the supplied CNTL_3P3Z_IQ_C_INIT macro.
...
#ifndef CNTL_3P3Z_IQ_C_H_
#define CNTL_3P3Z_IQ_C_H_
#include "IQmathLib.h"
 ...
 * @param CNTL_3P3Z_IQ_C_Coeffs structure with proper coefficient values.
 * @param CNTL_3P3Z_IQ_C_Vars structure with internal & output values.
 * @return CNTL_3P3Z_IQ_C_Vars Out parameter.
 */
#define CNTL_3P3Z_IQ_C(v, k)																	\
		/* Calculate error */																	\
		k.Errn = k.Ref - k.Fdbk;																\
		k.OutPresat = _IQ24mpy(v.Coeff_A3,k.Out3)+_IQ24mpy(v.Coeff_A2,k.Out2) + _IQ24mpy(v.Coeff_A1 , k.Out1) \
...
/*
 * Initial values for CNTL_3P3Z_IQ_C structures.
 */
#define CNTL_3P3Z_IQ_C_VAR_INIT(k)				\
...
#define CNTL_3P3Z_IQ_C_COEFF_INIT(v)			\
