...
//###########################################################################
//
// FILE:  Flash2823x_API_Library.h	
//
// TITLE: F2823x Flash Algo's main include file
//
// DESCRIPTION:
//
//       This file should be included in any project that uses any of the
//       the F2823x flash APIs or a fixed point project of the F2833x flash
//       APIs.
//
//###########################################################################
// $TI Release:$
...
#ifndef FLASH2823X_API_LIBRARY_H
#define FLASH2823X_API_LIBRARY_H
...
#if FLASH_F28235
// All sectors on an F28235 - Sectors A - H
#define SECTOR_F28235 (SECTORA|SECTORB|SECTORC|\
                       SECTORD|SECTORE|SECTORF|\
                       SECTORG|SECTORH)
#endif // -- end FLASH_F28235

#if FLASH_F28234
// All sectors on an F28234 - Sectors A - H
#define SECTOR_F28234 (SECTORA|SECTORB|SECTORC|\
                       SECTORD|SECTORE|SECTORF|\
                       SECTORG|SECTORH)
#endif // -- end FLASH_F28234

#if FLASH_F28232
// All sectors on an F28232 - Sectors A - D
#define SECTOR_F28232 (SECTORA|SECTORB|SECTORC|\
                       SECTORD)
#endif // -- end FLASH_F28232
...
#if FLASH_F28235
#define Flash_Erase(a,b)          Flash28235_Erase(a,b)
#define Flash_Program(a,b,c,d)    Flash28235_Program(a,b,c,d)
#define Flash_Verify(a,b,c,d)     Flash28235_Verify(a,b,c,d)
#define Flash_ToggleTest(a,b)     Flash28235_ToggleTest(a,b)
#define Flash_DepRecover()        Flash28235_DepRecover()
#define Flash_APIVersionHex()     Flash28235_APIVersionHex()
#define Flash_APIVersion()        Flash28235_APIVersion()
#endif

#if FLASH_F28234
#define Flash_Erase(a,b)          Flash28234_Erase(a,b)
#define Flash_Program(a,b,c,d)    Flash28234_Program(a,b,c,d)
#define Flash_Verify(a,b,c,d)     Flash28234_Verify(a,b,c,d)
#define Flash_ToggleTest(a,b)     Flash28234_ToggleTest(a,b)
#define Flash_DepRecover()        Flash28234_DepRecover()
#define Flash_APIVersionHex()     Flash28234_APIVersionHex()
#define Flash_APIVersion()        Flash28234_APIVersion()
#endif

#if FLASH_F28232
#define Flash_Erase(a,b)          Flash28232_Erase(a,b)
#define Flash_Program(a,b,c,d)    Flash28232_Program(a,b,c,d)
#define Flash_Verify(a,b,c,d)     Flash28232_Verify(a,b,c,d)
#define Flash_ToggleTest(a,b)     Flash28232_ToggleTest(a,b)
#define Flash_DepRecover()        Flash28232_DepRecover()
#define Flash_APIVersionHex()     Flash28232_APIVersionHex()
#define Flash_APIVersion()        Flash28232_APIVersion()
#endif
...
/*---------------------------------------------------------------------------
   ...
   Flash28_API:
   {
        Flash28235_API_Library.lib(.econst) 
        Flash28235_API_Library.lib(.text)
   } LOAD = FLASH, 
     RUN = SARAM, 
...
#endif // -- end FLASH2823x_API_LIBRARY_H 
