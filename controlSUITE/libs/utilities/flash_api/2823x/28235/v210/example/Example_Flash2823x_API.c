//###########################################################################
//
// FILE:  Example_Flash2823x_API.c	
//
// TITLE: F2823x Flash API Example
//
...
//
//###########################################################################
// $TI Release: F2823x API Release V2.10 $
...
/*------------------------------------------------------------------
 ...
 must be followed:
      ...
      1. Modify Flash2823x_API_Config.h for your targets operating
         conditions.
      2. Include Flash2823x_API_Library.h in the application.
...
------------------------------------------------------------------*/
   ...
   Uint16 Status;
/*------------------------------------------------------------------
 Initalize the PLLCR value before calling any of the F2823x Flash API 
 functions.
        
     Check to see if the PLL needs to changed
     PLLCR_VALUE is defined in Example_Flash2823x_API.h
...
/*------------------------------------------------------------------
  Initalize Flash_CPUScaleFactor.
   ...
   SCALE_FACTOR is defined in Example_Flash2823x_API.h as   
...
------------------------------------------------------------------*/
   ...
   // SECTORB, SECTORC are defined in Flash2823x_API_Library.h
...
------------------------------------------------------------------*/
   ...
   // SECTORB is defined in Flash2823x_API_Library.h
   ...
   // SECTORC is defined in Flash2823x_API_Library.h
...
Uint16 Example_CsmUnlock()
{
    ...
    // These are defined in Example_Flash2823x_CsmKeys.asm
