...
const composite_checksum_t csum_rom = {
        0x0003D4BE,	//total_ones
        0x0000D5A6, 0x00001F60, 00000000,	//bit_column_cksum[0][3];
        0x0000F47B, 0x00002478, 00000000,	//bit_column_cksum[1][3];
        0x00008939, 0x000023B0, 00000000,	//bit_column_cksum[2][3];
        0x0000AC70, 0x0000225C, 00000000,	//bit_column_cksum[3][3];
        0x00009FE8, 0x000020A4, 00000000,	//bit_column_cksum[4][3];
        0x0000A478, 0x00001FEC, 00000000,	//bit_column_cksum[5][3];
        0x0000DE61, 0x00001DAE, 00000000,	//bit_column_cksum[6][3];
        0x00002265, 0x00001CE9, 00000000,	//bit_column_cksum[7][3];
		0x00000000, 0x00000008, 0x00002870, 0x00008506,//row_weight_sum
		0x00000000, 0x000026B3, 0x0000E57C, 0x00000E77	//fact_weight_sum
};
