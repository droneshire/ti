...
;;###########################################################################
    ...
    .sect ".Version"
    .word 0x0002     ; Boot ROM Version v2.0
    .word 0x1209     ; Month/Year: (ex: 0x1209 = 12/09 = Dec 2009)

    .sect ".Checksum"; 64-bit Checksum
    .long 0x683ACBC6 ; least significant 32-bits
    .long 0x000008CC ; most significant 32-bits
