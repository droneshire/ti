...
struct DxLOCK_BITS {                                  // bit descriptions
    ...
    Uint16  LOCK_D0:1;                                // 2 Locks the write to access protection & master sel fields for D0 RAM 
    Uint16  LOCK_D1:1;                                // 3 Locks the write to access protection & master sel fields for D1 RAM 
...
struct DxCOMMIT_BITS {                                // bit descriptions
    Uint16  rsvd1:2;                                  // 1:0 Reserved 
    Uint16  COMMIT_D0:1;                              // 2 Permanently Locks the write to access protection & master sel fields for D0 RAM 
    Uint16  COMMIT_D1:1;                              // 3 Permanently Locks the write to access protection & master sel fields for D1 RAM 
    Uint16  rsvd2:12;                                 // 15:4 Reserved 
    Uint16  rsvd3:16;                                 // 31:16 Reserved 
};
...
struct LSxLOCK_BITS {                                 // bit descriptions
    Uint16  LOCK_LS0:1;                               // 0 Locks the write to access protection & master sel fields for LS0 RAM 
    Uint16  LOCK_LS1:1;                               // 1 Locks the write to access protection & master sel fields for LS1 RAM 
    Uint16  LOCK_LS2:1;                               // 2 Locks the write to access protection & master sel fields for LS2 RAM 
    Uint16  LOCK_LS3:1;                               // 3 Locks the write to access protection & master sel fields for LS3 RAM 
    Uint16  LOCK_LS4:1;                               // 4 Locks the write to access protection & master sel fields for LS4 RAM 
    Uint16  LOCK_LS5:1;                               // 5 Locks the write to access protection & master sel fields for LS5 RAM 
...
struct LSxCOMMIT_BITS {                               // bit descriptions
    Uint16  COMMIT_LS0:1;                             // 0 Permanently Locks the write to access protection & master sel fields for LS0 RAM 
    Uint16  COMMIT_LS1:1;                             // 1 Permanently Locks the write to access protection & master sel fields for LS1 RAM 
    Uint16  COMMIT_LS2:1;                             // 2 Permanently Locks the write to access protection & master sel fields for LS2 RAM 
    Uint16  COMMIT_LS3:1;                             // 3 Permanently Locks the write to access protection & master sel fields for LS3 RAM 
    Uint16  COMMIT_LS4:1;                             // 4 Permanently Locks the write to access protection & master sel fields for LS4 RAM 
    Uint16  COMMIT_LS5:1;                             // 5 Permanently Locks the write to access protection & master sel fields for LS5 RAM 
    Uint16  rsvd1:10;                                 // 15:6 Reserved 
    Uint16  rsvd2:16;                                 // 31:16 Reserved 
};
...
struct GSxLOCK_BITS {                                 // bit descriptions
    Uint16  LOCK_GS0:1;                               // 0 Locks the write to access protection & master sel fields for GS0 RAM 
    Uint16  LOCK_GS1:1;                               // 1 Locks the write to access protection & master sel fields for GS1 RAM 
    Uint16  LOCK_GS2:1;                               // 2 Locks the write to access protection & master sel fields for GS2 RAM 
    Uint16  LOCK_GS3:1;                               // 3 Locks the write to access protection & master sel fields for GS3 RAM 
    Uint16  LOCK_GS4:1;                               // 4 Locks the write to access protection & master sel fields for GS4 RAM 
    Uint16  LOCK_GS5:1;                               // 5 Locks the write to access protection & master sel fields for GS5 RAM 
    Uint16  LOCK_GS6:1;                               // 6 Locks the write to access protection & master sel fields for GS6 RAM 
    Uint16  LOCK_GS7:1;                               // 7 Locks the write to access protection & master sel fields for GS7 RAM 
    Uint16  LOCK_GS8:1;                               // 8 Locks the write to access protection & master sel fields for GS8 RAM 
    Uint16  LOCK_GS9:1;                               // 9 Locks the write to access protection & master sel fields for GS9 RAM 
    Uint16  LOCK_GS10:1;                              // 10 Locks the write to access protection & master sel fields for GS10 RAM 
    Uint16  LOCK_GS11:1;                              // 11 Locks the write to access protection & master sel fields for GS11 RAM 
    Uint16  LOCK_GS12:1;                              // 12 Locks the write to access protection & master sel fields for GS12 RAM 
    Uint16  LOCK_GS13:1;                              // 13 Locks the write to access protection & master sel fields for GS13 RAM 
    Uint16  LOCK_GS14:1;                              // 14 Locks the write to access protection & master sel fields for GS14 RAM 
    Uint16  LOCK_GS15:1;                              // 15 Locks the write to access protection & master sel fields for GS15 RAM 
...
struct GSxCOMMIT_BITS {                               // bit descriptions
    Uint16  COMMIT_GS0:1;                             // 0 Permanently Locks the write to access protection & master sel fields for GS0 RAM 
    Uint16  COMMIT_GS1:1;                             // 1 Permanently Locks the write to access protection & master sel fields for GS1 RAM 
    Uint16  COMMIT_GS2:1;                             // 2 Permanently Locks the write to access protection & master sel fields for GS2 RAM 
    Uint16  COMMIT_GS3:1;                             // 3 Permanently Locks the write to access protection & master sel fields for GS3 RAM 
    Uint16  COMMIT_GS4:1;                             // 4 Permanently Locks the write to access protection & master sel fields for GS4 RAM 
    Uint16  COMMIT_GS5:1;                             // 5 Permanently Locks the write to access protection & master sel fields for GS5 RAM 
    Uint16  COMMIT_GS6:1;                             // 6 Permanently Locks the write to access protection & master sel fields for GS6 RAM 
    Uint16  COMMIT_GS7:1;                             // 7 Permanently Locks the write to access protection & master sel fields for GS7 RAM 
    Uint16  COMMIT_GS8:1;                             // 8 Permanently Locks the write to access protection & master sel fields for GS2 RAM 
    Uint16  COMMIT_GS9:1;                             // 9 Permanently Locks the write to access protection & master sel fields for GS9 RAM 
    Uint16  COMMIT_GS10:1;                            // 10 Permanently Locks the write to access protection & master sel fields for GS10 RAM 
    Uint16  COMMIT_GS11:1;                            // 11 Permanently Locks the write to access protection & master sel fields for GS11 RAM 
    Uint16  COMMIT_GS12:1;                            // 12 Permanently Locks the write to access protection & master sel fields for GS12 RAM 
    Uint16  COMMIT_GS13:1;                            // 13 Permanently Locks the write to access protection & master sel fields for GS13 RAM 
    Uint16  COMMIT_GS14:1;                            // 14 Permanently Locks the write to access protection & master sel fields for GS14 RAM 
    Uint16  COMMIT_GS15:1;                            // 15 Permanently Locks the write to access protection & master sel fields for GS15 RAM 
    Uint16  rsvd1:16;                                 // 31:16 Reserved 
};
...
struct EMIF1LOCK_BITS {                               // bit descriptions
    Uint16  LOCK_EMIF1:1;                             // 0 Locks the write to access protection & master sel fields for EMIF1 
...
struct EMIF1COMMIT_BITS {                             // bit descriptions
    Uint16  COMMIT_EMIF1:1;                           // 0 Permanently Locks the write to access protection & master sel fields for EMIF1 
    Uint16  rsvd1:15;                                 // 15:1 Reserved 
    Uint16  rsvd2:16;                                 // 31:16 Reserved 
};
...
struct EMIF2LOCK_BITS {                               // bit descriptions
    Uint16  LOCK_EMIF2:1;                             // 0 Locks the write to access protection & master sel fields for EMIF2 
    Uint16  rsvd1:15;                                 // 15:1 Reserved 
    Uint16  rsvd2:16;                                 // 31:16 Reserved 
};
...
struct EMIF2COMMIT_BITS {                             // bit descriptions
    Uint16  COMMIT_EMIF2:1;                           // 0 Permanently Locks the write to access protection & master sel fields for EMIF2 
    Uint16  rsvd1:15;                                 // 15:1 Reserved 
    Uint16  rsvd2:16;                                 // 31:16 Reserved 
};
...
struct EMIF2MSEL_BITS {                               // bit descriptions
    Uint16  MSEL_EMIF2:2;                             // 1:0 Master Select for EMIF2 
...
union EMIF2MSEL_REG {
    Uint32  all;  
    struct  EMIF2MSEL_BITS  bit;  
};

struct EMIF2CLAPGM_BITS {                             // bit descriptions
    Uint16  CLAPGM_EMIF2:1;                           // 0 Selects EMIF2 memory as program vs data for CLA 
    Uint16  rsvd1:15;                                 // 15:1 Reserved 
    Uint16  rsvd2:16;                                 // 31:16 Reserved 
};

union EMIF2CLAPGM_REG {
    Uint32  all;  
    struct  EMIF2CLAPGM_BITS  bit;  
};
...
struct ROMCFG_BITS {                                  // bit descriptions
    Uint16  PREFETCHDIS:1;                            // 0 ROM Pre-Fetch Enable/Disable control 
    Uint16  rsvd1:15;                                 // 15:1 Reserved 
    Uint16  rsvd2:16;                                 // 31:16 Reserved 
};
...
#ifdef CPU1 
    union   ROMCFG_REG           ROMCFG;              // ROM Config register 
#elif defined(CPU2) 
