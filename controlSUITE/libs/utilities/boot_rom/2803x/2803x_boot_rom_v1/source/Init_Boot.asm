...
;; Checkin $Date: January 22, 2009   16:48:17 $
;;###########################################################################
;;
;; FILE:    Init_Boot.asm
;;
...
;;###########################################################################
    ...
    .sect ".Version"
    .word 0x0001     ; Boot ROM Version v1.0
    .word 0x0109     ; Month/Year: (ex: 0x0109 = 1/09 = Jan 2009)

    .sect ".Checksum"; 64-bit Checksum
    .long 0x455CFE90 ; least significant 32-bits
    .long 0x0000093D ; most significant 32-bits
