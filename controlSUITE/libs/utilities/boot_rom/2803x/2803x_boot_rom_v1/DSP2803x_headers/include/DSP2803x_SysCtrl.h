...
// Checkin $Date: January 22, 2009   16:47:09 $
//###########################################################################
//
...
struct XCLK_BITS   {    // bits  description
   ...
   Uint16 RESETPDDIS:1; // 5     Reset Pull-Down Disable bit
...
struct PCLKCR3_BITS  {       // bits  description
   Uint16 COMPDAC1ENCLK:1;   // 0     Enable SYSCLKOUT to COMP+DAC1
   Uint16 COMPDAC2ENCLK:1;   // 1     Enable SYSCLKOUT to COMP+DAC2
   Uint16 COMPDAC3ENCLK:1;   // 2     Enable SYSCLKOUT to COMP+DAC3
