...
;;   |_______|<- STK_PDATA       (SP-20)
;;   |_______|<- STK_DELTA       (SP-22)
;;   |_______|<- STK_GAMMA       (SP-24)
;;   |_______|<- STK_K           (SP-26)
;;   |_______|<- STK_B3_2_1_0    (SP-28)
;;   |_______|<- STK_B7_6_5_4    (SP-30)
;;   |_______|<- STK_X_X_X_B8    (SP-32)
;;   |_______|<- STK_TEMP        (SP-34)
;;   |_______|<- STK_TEMP_END    (SP-36)

;;
LOCAL_FRAME_SIZE            .set    38
STK_VRX_BASE                .set    0
STK_VR0                     .set    2
STK_VR1                     .set    4
STK_VR2                     .set    6
