...
;; Local Defines
STK_PLAMBDA                 .set    (LOCAL_FRAME_SIZE + 8 + 4  )
STK_POMEGA                  .set    (LOCAL_FRAME_SIZE + 8 + 6  )
STK_PPACKEDALPHA            .set    (LOCAL_FRAME_SIZE + 8 + 8  )
STK_PPACKEDBETA             .set    (LOCAL_FRAME_SIZE + 8 + 10 )
STK_PRSEXPTABLE             .set    (LOCAL_FRAME_SIZE + 8 + 12 )
STK_PRSLOGTABLE             .set    (LOCAL_FRAME_SIZE + 8 + 14 )
STK_PERRORLOC               .set    (LOCAL_FRAME_SIZE + 8 + 16 )
