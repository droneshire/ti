...
;******************************************************************************
; 
; FILE: cfft16_utils.asm
; 
; DESCRIPTION: Initialization and auxilliary functions used in the fft 
;              calculations
;
;******************************************************************************
...
;                          All Rights Reserved.
;******************************************************************************
      .cdecls   C,LIST,"fft.h" ;needed as the table CFFT16_TF is defined in fft.h
;############################################################################
;
