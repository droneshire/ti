...
*******************************************************************************
* 
* FILE: Test_VCU_CFFT256.c
*
* DESCRIPTION: Example showing the 256 point complex fft
* 
*******************************************************************************
 ...
 *
 * Rearrange the input data in bit reversed format and call the FFT routine
 * to get the complex FFT
 *
 * \return none
 */
void cfft16(cfft16_t *fft_hnd)
