...
PAGE 0 :
   ...
   RAML0_L2    : origin = 0x008000, length = 0x000C00	 /* on-chip RAM block L0-L2 */
...
SECTIONS
{
   ...
   CRC8_TABLE       : > RAML5,     PAGE = 1
   CRC16_TABLE      : > RAML6,     PAGE = 1
   CRC32_TABLE      : > RAML7,     PAGE = 1 
...
UNION {
	UNION {
	   ...
	   }crc_table(_CRCTestVector,algorithm = CRC16_802_15_4)
	 }crc_table(_CRCTestVector,algorithm = CRC16_ALT)
}crc_table(_CRCTestVector,algorithm = CRC32_PRIME)
