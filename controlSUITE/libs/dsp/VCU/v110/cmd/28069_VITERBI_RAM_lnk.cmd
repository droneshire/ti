...
//###########################################################################
//
// FILE:    28069_VITERBI_RAM_lnk.cmd
//
...
PAGE 1 :
   ...
   RAML3_L5       : origin = 0x009000, length = 0x005000 /* on-chip RAM blocks L3,L4 and L5 */
...
SECTIONS
{
   ...
   .stack           : > RAMM1,     PAGE = 1
   .ebss            : > RAML3_L5,  PAGE = 1
   .econst          : > RAML3_L5,  PAGE = 1
   .esysmem         : > RAML6,     PAGE = 1
   .shadow          : > RAML8,     PAGE = 1

   buffer_out       : ALIGN = 2 >  RAML8,  
                                   PAGE = 1
