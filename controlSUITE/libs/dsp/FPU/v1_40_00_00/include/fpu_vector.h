...
//! \attention N must be at least 2
//
extern void mpy_SP_RVxCV(complex_float *y, const complex_float *w, const float *x, const uint16_t N);
...
//! \attention N must be even and a minimum of 4.
//
extern void mpy_SP_RVxRV_2(float *y, const float *w, const float *x, const uint16_t N);
