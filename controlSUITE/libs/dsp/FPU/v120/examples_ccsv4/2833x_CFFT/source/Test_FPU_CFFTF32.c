...
// Checkin $Date: January 6, 2011   18:10:53 $
// =====================================================================================
...
//   	Data section allignment (#prgram ...) is not necessary for CFFT_f32u 
...
#pragma	DATA_SECTION(CFFTin1Buff,"CFFTdata1");  //Buffer alignment,optional for CFFT_f32u 
												//				   required by CFFT_f32
float	CFFTin1Buff[CFFT_SIZE*2];
#pragma	DATA_SECTION(CFFTin2Buff,"CFFTdata2");  //Buffer alignment,optional for CFFT_f32u 
												//				   required by CFFT_f32
float	CFFTin2Buff[CFFT_SIZE*2];
#pragma	DATA_SECTION(CFFToutBuff,"CFFTdata3");	//Buffer alignment,optional for CFFT_f32u 
												//				   required by CFFT_f32
float	CFFToutBuff[CFFT_SIZE*2];
#pragma	DATA_SECTION(CFFTF32Coef,"CFFTdata4");  //Buffer alignment,optional for CFFT_f32u 
												//				   required by CFFT_f32
