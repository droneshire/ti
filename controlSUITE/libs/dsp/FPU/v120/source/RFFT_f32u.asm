...
; Checkin $Date: January 6, 2011   18:11:21 $
; ========================================================================
...
; DESCRIPTION:
;
;    This function calcuates a real FFT.  The input buffer does not have to
;    be aligned.  If alignment can be done, then use the RFFT_f32 function to
;    improve performance.
;
; FUNCTIONS:
;
;    void RFFT_f32u (FFT_REAL *)
;
...
;===========================================================================
; Function: void RFFT_f32u(FFT_REAL *fft)
;===========================================================================
...
;===========================================================================
; Function: void rfft_f32u_Stages1and2and3andBitReverse(RFFT_F32_STRUCT *rfft)
;===========================================================================
;---------------------------------------------------------------------------
;
; DESCRIPTION:
