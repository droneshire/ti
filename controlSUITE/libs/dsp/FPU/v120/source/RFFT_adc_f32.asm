...
;===========================================================================
; Function: void RFFT_adc_f32(RFFT_ADC_F32_STRUCT *fft)
;===========================================================================
; RFFT_adc_f32_Stages1and2and3andBitReverse(RFFT_ADC_F32_STRUCT *);
; RFFT_adc_f32_Stages4andUp(RFFT_ADC_F32_STRUCT *);
;
...
;===========================================================================
; Function: void rfft_adc_f32_Stages1and2and3andBitReverse(RFFT_F32_STRUCT *rfft)
;===========================================================================
;---------------------------------------------------------------------------
;
; DESCRIPTION:
...
;===========================================================================
; Function: void rfft_f32_Stages4andUp(RFFT_F32_STRUCT *)
;===========================================================================
;===========================================================================
;
; ON ENTRY:
...
;----------------------------------------------------------------------
       ...
       B        _rfft_f32_End,LEQ
       MOV      *-SP[IDX_I],AL               ; IDX_I = FFTStages - 3 = i for stages loop control
       ...
       DEC      AL
       MOV      AR6, AL                      ; IDX_M = FFTSize/16-1 = m for outer loop control
