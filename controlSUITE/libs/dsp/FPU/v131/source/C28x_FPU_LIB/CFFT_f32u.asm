...
;    the input buffer then use the CFFT_f32u function.  Using this function 
;    will reduce cycle performance of the algorithm.
;
; FUNCTIONS:
;
;    void CFFT_f32u (FFT_REAL *)
...
;===========================================================================
; Function: void CFFT_f32u(FFT_COMPLEX *cfft)
;===========================================================================
