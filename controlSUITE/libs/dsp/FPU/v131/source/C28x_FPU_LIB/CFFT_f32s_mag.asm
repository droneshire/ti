...
; Checkin $Date: January 6, 2011   18:11:14 $
; =============================================================================
...
;
; TITLE: Complex FFT scaled magnitude calculations
;
; DESCRIPTION:
;
...
; FUNCTIONS:
;
;    void CFFT_f32s_mag (RFFT_F32_STRUCT *)
;
...
;----------------------------------------------------------------------
        ...
        MOV      AL, *+XAR4[4]
        SUBB     AL, #2
        B _cfft_f32_mag_end, LEQ        ; falls to zero, end the function
...
_cfft_f32_scale_value:

        MPYF32   R5H,R5H,#0.5           ; R5H = scale
        NOP

        BANZ _cfft_f32_scale_value,AR7--
