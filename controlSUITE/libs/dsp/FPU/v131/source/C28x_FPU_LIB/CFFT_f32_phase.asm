...
; Checkin $Date: January 6, 2011   18:11:16 $
; =============================================================================
...
;                          All Rights Reserved.
;=========================================================================
; FILE:  CFFT_f32_phase.asm
;
; TITLE: Complex FFT phase calculations
;
; DESCRIPTION:
;
...
; FUNCTIONS:
;
;    void CFFT_f32_phase (RFFT_F32_STRUCT *)
;
...
_cfft_f32_calc_phase:
        ...
        MOV32    R1H, *XAR3++           ; R2H = CurrentInPtr[Rptr++];
        MOV32    R0H, *XAR3++           ; R4H = CurrentInPtr[Iptr++]                
        PUSH     XAR6                   ; Save on call
        LCR      _atan2                  ; R0H = Phase = atan2(Imag, Real);
        POP      XAR6
        MOV32    *XAR1++,R0H            ; MagBuf[Mptr++] = Mag
        BANZ     _cfft_f32_calc_phase, AR6--
