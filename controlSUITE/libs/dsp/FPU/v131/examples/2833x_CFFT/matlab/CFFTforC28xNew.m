...
% //    function CFFT_f32 and example project 2833x_CFFT. The structure 
% //    of the code is exactly the same as the one in CFFT_f32.asm.
% //
% //   
% //   	Minimum CFFT_Stages is 3. Since Matlab's default precision 
% //    is double precision and CFFT_f32 uses single precision.
% //    User can notice significant difference if stages larger than 9 
% //    between matlab result and C28x result due to quantitization
% //    effects.
% //
% //   
% //    Watch Variables:
...
disp('this is Matlab version of C28x CFFT code');
disp('The result is stored in array X');
disp('The signal is stored in array x');
disp('The spectrum magnitude is stored in Magnitude');
disp('The spectrum phase is stored in Phase');
