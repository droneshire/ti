...
x = sin(2*pi*k1.*n)+sin(2*pi*k2.*n)+sin(2*pi*k3.*n);
x_raw_sig = x/3;
x_Q15=2^15*x_raw_sig;
...
for k=1:length(x_Q15)
    ...
    x_no_scale_biq_fixed(k)=(accum1)/2^qformat;      % direct I form high order implementation output
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%% Write the input/output vectors to file
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
X   = reshape(x_Q15, N/8, 8);
...
Y   = reshape(x_output_final, N/8, 8);
