...
% //======================================================================================
% //
% // 	FILE:    FixedRFFTnoWin.m
% //
% // 	TITLE:   DSP2833x Device Fixed Point Real FFT Test Program.   
% //
% //
% // 	ASSUMPTIONS:
% //
% //   	This matlab code is reference code for debugging FixedPoint DSP library
% //    module RFFT32 and example project 2833x_FixedPoint_RFFT. 
% //
% //
% //   
% //    Watch Variables:
...
% //      fft_float         Normalized floating fft result represented as (Q30) 
% //
% //######################################################################################
...
disp('fft_float stored the fft(x_raw_sig)/N in Q31 format');
