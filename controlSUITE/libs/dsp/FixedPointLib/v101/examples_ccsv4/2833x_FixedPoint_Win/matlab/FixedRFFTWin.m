...
% // 	FILE:    FixedRFFTWin.m
% //
% // 	TITLE:   DSP2833x Device Fixed Point Windowed Input Real FFT Test Program.   
% //
% //
% // 	ASSUMPTIONS:
% //
% //   	This matlab code is reference code for debugging FixedPoint DSP library
% //    function FFT32_win and example project 2833x_FixedPoint_Win. 
% //
% //
% //   
% //    Watch Variables:
...
% //                        (Q31) 
% //	  x_win/2			Windowed input signal with hamming 32 window
% //      x_out_2nd         2nd Stage FFT result
% //      X                 Stage 3 and up result (Q31)
% //      Magnitude_Fixed   Spectrum magnitude (Q30)
...
disp('fft_float stored the fft(x_raw_sig)/N in Q30 format');
disp('Magnitude_Fixed in Q30 format');
disp('==============================================================');
