...
;;---------------------------------------------------------------------------- 
    ...
    .align  2
__CLAsincos_sp .usect  ".scratchpad:Cla1Prog:_CLAsincos",8,0,1

_CLAsincos:
    .asmfunc
    .asg    __CLAsincos_sp + 0, _save_MR3
    .asg    __CLAsincos_sp + 2, _ptr_y1
    .asg    __CLAsincos_sp + 3, _ptr_y2
    .asg    __CLAsincos_sp + 4, _sincos_tmp1
    .asg    __CLAsincos_sp + 6, _sincos_tmp2
; Context Save
