...
;//
;// The task1 calls the CLA Sin & SinPU macro which is defined in
;// the file CLAmathLib_type0.inc as:
;//
;// CLASin    .macro  y, rad, table     ; y = sin(rad)
;// CLASinPU  .macro  y, radPU, table     ; y = sin(radPU)
...
_Cla1Task1:
   ...
   CLAsinPU  Cla1ToCpuMsg.y0.f32,  CpuToCla1Msg.rad0
   CLAsin    Cla1ToCpuMsg.y1.f32,  CpuToCla1Msg.rad1
   CLAsinPU  Cla1ToCpuMsg.y2.f32,  CpuToCla1Msg.rad2
   CLAsin    Cla1ToCpuMsg.y3.f32,  CpuToCla1Msg.rad3
   CLAsinPU  Cla1ToCpuMsg.y4.f32,  CpuToCla1Msg.rad4
   CLAsin    Cla1ToCpuMsg.y5.f32,  CpuToCla1Msg.rad5
   CLAsinPU  Cla1ToCpuMsg.y6.f32,  CpuToCla1Msg.rad6
   CLAsin    Cla1ToCpuMsg.y7.f32,  CpuToCla1Msg.rad7
   CLAsinPU  Cla1ToCpuMsg.y8.f32,  CpuToCla1Msg.rad8
   CLAsin    Cla1ToCpuMsg.y9.f32,  CpuToCla1Msg.rad9
   CLAsinPU  Cla1ToCpuMsg.y10.f32, CpuToCla1Msg.rad10
   CLAsin    Cla1ToCpuMsg.y11.f32, CpuToCla1Msg.rad11
   CLAsinPU  Cla1ToCpuMsg.y12.f32, CpuToCla1Msg.rad12
   CLAsin    Cla1ToCpuMsg.y13.f32, CpuToCla1Msg.rad13
   CLAsinPU  Cla1ToCpuMsg.y14.f32, CpuToCla1Msg.rad14
   CLAsin    Cla1ToCpuMsg.y15.f32, CpuToCla1Msg.rad15
   CLAsinPU  Cla1ToCpuMsg.y16.f32, CpuToCla1Msg.rad16
   CLAsin    Cla1ToCpuMsg.y17.f32, CpuToCla1Msg.rad17
   CLAsinPU  Cla1ToCpuMsg.y18.f32, CpuToCla1Msg.rad18
