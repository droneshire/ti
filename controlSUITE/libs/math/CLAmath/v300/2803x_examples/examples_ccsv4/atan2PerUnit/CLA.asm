...
;//
;// Each task calls the CLA atan2 & atan2PU macro which is defined in
;// the file  CLAmathLib_type0.inc as:
;//
;//    CLAatan2   .macro  Dest, Num, Den    ; Dest = atan2(Num/Den)
;//    CLAatan2PU .macro  Dest, Num, Den    ; Dest = atan2(Num/Den)/2pi
...
_Cla1Task1:
       ...
       .endif
		...
		CLAatan2PU		Cla1ToCpuMsg.zpu1.f32, CpuToCla1Msg.y1, CpuToCla1Msg.x1
		MSTOP
_Cla1Task1End:
...
_Cla1Task2:
       ...
       .endif
		...
		CLAatan2PU		Cla1ToCpuMsg.zpu2.f32, CpuToCla1Msg.y2, CpuToCla1Msg.x2
		MSTOP
_Cla1Task2End:
...
_Cla1Task3:
       ...
       .endif
		...
		CLAatan2PU		Cla1ToCpuMsg.zpu3.f32, CpuToCla1Msg.y3, CpuToCla1Msg.x3
		MSTOP
_Cla1Task3End:
...
_Cla1Task4:
       ...
       .endif
		...
		CLAatan2PU		Cla1ToCpuMsg.zpu4.f32, CpuToCla1Msg.y4, CpuToCla1Msg.x4
		MSTOP
_Cla1Task4End:
...
_Cla1Task5:
       ...
       .endif
		...
		CLAatan2PU		Cla1ToCpuMsg.zpu5.f32, CpuToCla1Msg.y5, CpuToCla1Msg.x5
		MSTOP
_Cla1Task5End:
...
_Cla1Task6:
       ...
       .endif
		...
		CLAatan2PU		Cla1ToCpuMsg.zpu6.f32, CpuToCla1Msg.y6, CpuToCla1Msg.x6
		MSTOP
_Cla1Task6End:
...
_Cla1Task7:
       ...
       .endif
		...
		CLAatan2PU		Cla1ToCpuMsg.zpu7.f32, CpuToCla1Msg.y7, CpuToCla1Msg.x7
		MSTOP
_Cla1Task7End:
...
_Cla1Task8:
       ...
       .endif
		...
		CLAatan2PU		Cla1ToCpuMsg.zpu8.f32, CpuToCla1Msg.y8, CpuToCla1Msg.x8
		MSTOP
_Cla1Task8End:
