...
;//
;// Each task calls the CLA cos macro which is defined in
...
_Cla1Task1:
   ...
   CLAcos  Cla1ToCpuMsg.y8.f32,  CpuToCla1Msg.rad8
   CLAcos  Cla1ToCpuMsg.y9.f32,  CpuToCla1Msg.rad9
   CLAcos  Cla1ToCpuMsg.y10.f32, CpuToCla1Msg.rad10
   CLAcos  Cla1ToCpuMsg.y11.f32, CpuToCla1Msg.rad11
   CLAcos  Cla1ToCpuMsg.y12.f32, CpuToCla1Msg.rad12
   CLAcos  Cla1ToCpuMsg.y13.f32, CpuToCla1Msg.rad13
   CLAcos  Cla1ToCpuMsg.y14.f32, CpuToCla1Msg.rad14
   CLAcos  Cla1ToCpuMsg.y15.f32, CpuToCla1Msg.rad15
   CLAcos  Cla1ToCpuMsg.y16.f32, CpuToCla1Msg.rad16
   CLAcos  Cla1ToCpuMsg.y17.f32, CpuToCla1Msg.rad17
   CLAcos  Cla1ToCpuMsg.y18.f32, CpuToCla1Msg.rad18
