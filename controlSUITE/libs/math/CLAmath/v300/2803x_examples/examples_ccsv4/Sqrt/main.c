...
//
//   This is a basic program to exercise the CLA square root macro.
//
//   All CLA tasks are used.  Each task clears the overflow and
//   underflow flags before execution.  Each task is populated
//   with the square root macro.  Macro input and output are
...
// Task 1a:
//-------------------------------------------------------------
   CpuToCla1Msg.x1 = 0.0;      // y1 = 0.0, Set LVF
...
// Task 2:
//-------------------------------------------------------------
   CpuToCla1Msg.x2 = 2.0;      // y2 = 1.41421356
   ...
   if(   (Cla1ToCpuMsg.y2.i32 == 0x3FB504F3)
       & (Cla1Regs._MSTF.bit.LUF == 0)
...
// Task 3:
//-------------------------------------------------------------
   CpuToCla1Msg.x3 = 33.33333L; // y3 = 5.773501
   ...
   if(   (Cla1ToCpuMsg.y3.i32 == 0x40B8C086)
       & (Cla1Regs._MSTF.bit.LUF == 0)
       & (Cla1Regs._MSTF.bit.LVF == 0)
       & (Cla1Regs._MSTF.bit.NF == 0)
       & (Cla1Regs._MSTF.bit.ZF == 0) )
...
// Task 4:
//-------------------------------------------------------------
   CpuToCla1Msg.x4 = 18.0625L;  // y4 = sqrt(18.0625) = 4.25
   ...
   if(   (Cla1ToCpuMsg.y4.i32 == 0x4087FFFF)
       & (Cla1Regs._MSTF.bit.LUF == 0)
       & (Cla1Regs._MSTF.bit.LVF == 0)
       & (Cla1Regs._MSTF.bit.NF == 0)
       & (Cla1Regs._MSTF.bit.ZF == 0) )
...
// Task 5:
//-------------------------------------------------------------
   CpuToCla1Msg.x5 = 12.6736L;  // y5 = sqrt(12.6736) = 3.56
   ...
   if(   (Cla1ToCpuMsg.y5.i32 == 0x4063D70A)
       & (Cla1Regs._MSTF.bit.LUF == 0)
       & (Cla1Regs._MSTF.bit.LVF == 0)
       & (Cla1Regs._MSTF.bit.NF == 0)
       & (Cla1Regs._MSTF.bit.ZF == 0) )
...
// Task 6:
//-------------------------------------------------------------
   CpuToCla1Msg.x6 = -9.0L; // y6 = -0.0, set LVF
   ...
   if(   (Cla1ToCpuMsg.y6.i32 == 0x80000000)
       & (Cla1Regs._MSTF.bit.LUF == 0)
       & (Cla1Regs._MSTF.bit.LVF == 1)
...
// Task 7:
//-------------------------------------------------------------
   CpuToCla1Msg.x7 = 12.87L; // y7 = 3.587478
   ...
   if(   (Cla1ToCpuMsg.y7.i32 == 0x4065993D)
       & (Cla1Regs._MSTF.bit.LUF == 0)
       & (Cla1Regs._MSTF.bit.LVF == 0)
       & (Cla1Regs._MSTF.bit.NF == 0)
       & (Cla1Regs._MSTF.bit.ZF == 0) )
...
// Task 8:
//-------------------------------------------------------------
   CpuToCla1Msg.x8 = -1.0;     // y8 = -0.0, set LVF
   ...
   if(   (Cla1ToCpuMsg.y8.i32 == 0x80000000)
       & (Cla1Regs._MSTF.bit.LUF == 0)
       & (Cla1Regs._MSTF.bit.LVF == 1)
       & (Cla1Regs._MSTF.bit.NF == 1)
       & (Cla1Regs._MSTF.bit.ZF == 0) )
