...
_Cla1Task1:
       ...
       .endif
		...
		CLAsqrt		Cla1ToCpuMsg.y1.f32, CpuToCla1Msg.x1
		MSTOP
_Cla1Task1End:
...
_Cla1Task2:
       ...
       .endif
   		MSETFLG   	LUF=0,LVF=0,RNDF32=0
		CLAsqrt		Cla1ToCpuMsg.y2.f32, CpuToCla1Msg.x2
		MSTOP
_Cla1Task2End:
...
_Cla1Task3:
       ...
       .endif
   		MSETFLG   	LUF=0,LVF=0,RNDF32=0
		CLAsqrt		Cla1ToCpuMsg.y3.f32, CpuToCla1Msg.x3
		MSTOP
_Cla1Task3End:
...
_Cla1Task4:
       ...
       .endif
   		MSETFLG   	LUF=0,LVF=0,RNDF32=0
		CLAsqrt		Cla1ToCpuMsg.y4.f32, CpuToCla1Msg.x4
		MSTOP
_Cla1Task4End:
...
_Cla1Task5:
       ...
       .endif
   		MSETFLG   	LUF=0,LVF=0,RNDF32=0
		CLAsqrt		Cla1ToCpuMsg.y5.f32, CpuToCla1Msg.x5
		MSTOP
_Cla1Task5End:
...
_Cla1Task6:
       ...
       .endif
   		MSETFLG   	LUF=0,LVF=0,RNDF32=0
		CLAsqrt		Cla1ToCpuMsg.y6.f32, CpuToCla1Msg.x6
		MSTOP
_Cla1Task6End:
...
_Cla1Task7:
       ...
       .endif
   		MSETFLG   	LUF=0,LVF=0,RNDF32=0
		CLAsqrt		Cla1ToCpuMsg.y7.f32, CpuToCla1Msg.x7
		MSTOP
_Cla1Task7End:
...
_Cla1Task8:
       ...
       .endif
   		MSETFLG   	LUF=0,LVF=0,RNDF32=0
		CLAsqrt		Cla1ToCpuMsg.y8.f32, CpuToCla1Msg.x8
		MSTOP
_Cla1Task8End:
