...
//
//   This is a basic program to exercise the CLA  Exponential macro.
//
//   Each task clears the overflow and
//   underflow flags before execution.  The tasks 1-5 are populated
//   with Exp macro.  Macro input and output are
...
//
Uint16 GOLDEN_PASS_COUNT = 6;   // Number of test in this program
Uint16 PASS_COUNT = 0;          // If all tests pass, this should equal golden value
Uint16 FAIL_COUNT = 0;          // Number of tests that failed

float y_x1=0.0,y_x2=0.0,y_x3=0.0,y_x4=0.0,y_x5=0.0,y_x6=0.0;
...
CpuToCla1Msg.x1 = 88.0;  
   ...
   // This macro is defined in the Cla_Defines.h file
   	...
   	Cla1ForceTask1andWait()
	y_x6=Cla1ToCpuMsg.y1.f32;
//-------------------------------------------------------------
// start of test
//-------------------------------------------------------------
   chk1=1- y_x1;      
   chk2=2.7182818284 - y_x2;
   chk3=10 - y_x3;    
   chk4=0.1224564282-y_x4;
   chk5= 1.4944622845- (y_x5 / 1e+38);	  
   chk6=1.6516362550 - (y_x6 / 1e+38);
