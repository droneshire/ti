...
;//
;// Each task calls the CLA LogN macro which is defined in
;// the file CLAmathLib_type0.inc as:
;//
;//    LogN   .macro  Dest, Source1, source2    ; Dest = LogN(Source1, Source2)
;//
...
_Cla1Task2:
       ...
       .endif
   		MSETFLG   	LUF=0,LVF=0,RNDF32=0,TF=0
		CLALogN		Cla1ToCpuMsg.y1.f32,Cla1ToCpuMsg.y2.f32,Cla1ToCpuMsg.y3.f32 , CpuToCla1Msg.Num1, CpuToCla1Msg.Base1
		MSTOP
_Cla1Task2End:
