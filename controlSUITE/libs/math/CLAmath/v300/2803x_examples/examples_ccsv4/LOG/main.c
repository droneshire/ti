...
//
//   This is a basic program to exercise the CLA  LogN macro.
//
//   The CLA task2 is used. The task clears the overflow and
//   underflow flags before execution.  The task is populated
//   with the LogN macro.  Macro input and output are
