...
//
//   This is a basic program to exercise the CLA  ExpN macro.
//
//   The CLA tasks 1-5 are used.  Each task clears the overflow and
//   underflow flags before execution.  Each task is populated
//   with the ExpN macro.  Macro input and output are
...
//-------------------------------------------------------------
	...
	CpuToCla1Msg.Num1 = 64.0;  
	CpuToCla1Msg.X1 = 0.333333333333333333333333;
...
//-------------------------------------------------------------
   chk1=0.25- y_x1;               
   chk2=1 - y_x2;
   chk3=0.003267725436 - y_x3;    
   chk4=2.61995201-y_x4/1e+05;
   chk5=4 - (y_x5 );
