...
//
//   This is a basic program to exercise the CLA  Exp2 macro.
//
//   The CLA tasks 1-5 are used.  The task clears the overflow and
//   underflow flags before execution.  Tasks are populated with the Exp2 macro.  
...
float chk1=0.0,chk2=0.0,chk3=0.0,chk4=0.0,chk5=0.0;
...
// Test 1:
//-------------------------------------------------------------
   	CpuToCla1Msg.Num1 = 0.0; 
   	CpuToCla1Msg.Den1 =- 2.0;     
...
//-------------------------------------------------------------
	...
	CpuToCla1Msg.Num1 = 147; 
	CpuToCla1Msg.Den1 = -70.0; 
