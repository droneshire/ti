...
;//
;// The tasks 1-5 call the CLA Exp2 macro which is defined in
;// the file CLAmathLib_type0.inc as:
;//
;//    CLAEnp2   .macro  Dest, Source1, Source2    ; Dest = atan(Source1/Source2)
;//
...
_Cla1Task1:
       ...
       .endif
		...
		CLAexp2		Cla1ToCpuMsg.y1.f32, CpuToCla1Msg.Num1, CpuToCla1Msg.Den1
		MSTOP
_Cla1Task1End:
