...
;// Checkin $Date: May 28, 2009   15:39:54 $
;//###########################################################################
;//
;// FILE:  Cla.asm
;//
...
;//
;// Each task calls the CLA Division macro which is defined in
;// the file CLAMathLib.inc as:
;//
;//    CLADiv   .macro  Dest, Num, Den    ; Dest = Num/Den
;//
...
_Cla1Task1:
       ...
       CLADiv       Cla1ToCpuMsg.y1.f32, CpuToCla1Msg.Num1, CpuToCla1Msg.Den1
       MSTOP
_Cla1Task1End:
...
_Cla1Task2:
       ...
       MDEBUGSTOP
       MSETFLG      LUF=0,LVF=0,RNDF32=0
       CLADiv       Cla1ToCpuMsg.y2.f32, CpuToCla1Msg.Num2, CpuToCla1Msg.Den2
       MSTOP
_Cla1Task2End:
...
_Cla1Task3:
       ...
       MDEBUGSTOP
       MSETFLG      LUF=0,LVF=0,RNDF32=0
       CLADiv       Cla1ToCpuMsg.y3.f32, CpuToCla1Msg.Num3, CpuToCla1Msg.Den3
       MSTOP
_Cla1Task3End:
...
_Cla1Task4:
       ...
       MDEBUGSTOP
       MSETFLG      LUF=0,LVF=0,RNDF32=0
       CLADiv       Cla1ToCpuMsg.y4.f32, CpuToCla1Msg.Num4, CpuToCla1Msg.Den4
       MSTOP
_Cla1Task4End:
...
_Cla1Task5:
       ...
       MDEBUGSTOP
       MSETFLG      LUF=0,LVF=0,RNDF32=0
       CLADiv       Cla1ToCpuMsg.y5.f32, CpuToCla1Msg.Num5, CpuToCla1Msg.Den5
       MSTOP
_Cla1Task5End:
...
_Cla1Task6:
       ...
       MDEBUGSTOP
       MSETFLG      LUF=0,LVF=0,RNDF32=0
       CLADiv       Cla1ToCpuMsg.y6.f32, CpuToCla1Msg.Num6, CpuToCla1Msg.Den6
       MSTOP
_Cla1Task6End:
...
_Cla1Task7:
       ...
       MDEBUGSTOP
       MSETFLG      LUF=0,LVF=0,RNDF32=0
       CLADiv       Cla1ToCpuMsg.y7.f32, CpuToCla1Msg.Num7, CpuToCla1Msg.Den7
       MSTOP
_Cla1Task7End:
...
_Cla1Task8:
       ...
       MDEBUGSTOP
       MSETFLG      LUF=0,LVF=0,RNDF32=0
       CLADiv       Cla1ToCpuMsg.y8.f32, CpuToCla1Msg.Num8, CpuToCla1Msg.Den8
       MSTOP
_Cla1Task8End:
