//#############################################################################
//
//  File:   f2802x_examples_ccsv4/hrpwm_duty_sfo_v6/Example_2802xHRPWM_Duty_SFO_V6.c
//
...
//!  -# Run the code
//!  -# Watch ePWM1-4 waveforms on a Oscillosope
//!  -# In the watch window:
...
//                }
                ...
                PWM_setCmpA(myPwm1, ((long)DutyFine * PWM_getPeriod(myPwm1)>>15));
                PWM_setCmpA(myPwm2, ((long)DutyFine * PWM_getPeriod(myPwm2)>>15));
                PWM_setCmpA(myPwm3, ((long)DutyFine * PWM_getPeriod(myPwm3)>>15));
                PWM_setCmpA(myPwm4, ((long)DutyFine * PWM_getPeriod(myPwm4)>>15));
            }
