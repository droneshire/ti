//#############################################################################
//
//  File:   f2802x_examples_ccsv4/sw_prioritized_interrupts/Example_F2802xSWPrioritizedInterrupts.c
//
...
//!         in the F2802x_SWPrioritizedIsrLevels.h file.
...
//!   -# At the end of each test there is a hard coded breakpoint (ESTOP0).  When code
...
#define ISRS_GROUP10 (M_INT3|M_INT4|M_INT5|M_INT6|M_INT7|M_INT8) // If M_INT1,M_INT2 are available in Group 10, delete them in Group 1
...
//     Force all group 1 interrupts at once by writing to the PIEIFR1 register
        ...
        PIE_forceInt(myPie, PIE_GroupNumber_1, (PIE_InterruptSource_e)(PIE_InterruptSource_ADCINT_1_1
                | PIE_InterruptSource_ADCINT_1_2 | PIE_InterruptSource_XINT_1 | PIE_InterruptSource_XINT_2
...
//     Force all group 2 interrupts at once by writing to the PIEIFR2 register
        ...
        PIE_forceInt(myPie, PIE_GroupNumber_2, (PIE_InterruptSource_e)(PIE_InterruptSource_TZ1
                | PIE_InterruptSource_TZ2 | PIE_InterruptSource_TZ3));
...
//     Force all group 3 interrupts at once by writing to the PIEIFR3 register
        ...
        PIE_forceInt(myPie, PIE_GroupNumber_3, (PIE_InterruptSource_e) (PIE_InterruptSource_EPWM1
                | PIE_InterruptSource_EPWM2 | PIE_InterruptSource_EPWM3));
...
//     Force all group 4 interrupts at once by writing to the PIEIFR4 register
        ...
        PIE_forceInt(myPie, PIE_GroupNumber_4, (PIE_InterruptSource_e) PIE_InterruptSource_ECAP1);
...
//     Force all group 6 interrupts at once by writing to the PIEIFR6 register
        ...
        PIE_forceInt(myPie, PIE_GroupNumber_6, (PIE_InterruptSource_e) (PIE_InterruptSource_SPIARX
...
//     Force all group 9 interrupts at once by writing to the PIEIFR4 register
        ...
        PIE_forceInt(myPie, PIE_GroupNumber_9, (PIE_InterruptSource_e) (PIE_InterruptSource_SCIARX
...
//     Force all used PIE interrupts at once
        ...
        PIE_forceInt(myPie, PIE_GroupNumber_6, (PIE_InterruptSource_e) (PIE_InterruptSource_SPIARX
                | PIE_InterruptSource_SPIATX));
        PIE_forceInt(myPie, PIE_GroupNumber_8, (PIE_InterruptSource_e) (PIE_InterruptSource_I2CA1
                | PIE_InterruptSource_I2CA2));
        PIE_forceInt(myPie, PIE_GroupNumber_9, (PIE_InterruptSource_e) (PIE_InterruptSource_SCIARX
                | PIE_InterruptSource_SCIATX));
        PIE_forceInt(myPie, PIE_GroupNumber_10, (PIE_InterruptSource_e) (PIE_InterruptSource_ADCINT_10_1
                | PIE_InterruptSource_ADCINT_10_2 | PIE_InterruptSource_ADCINT_3
                | PIE_InterruptSource_ADCINT_4 | PIE_InterruptSource_ADCINT_5
                | PIE_InterruptSource_ADCINT_6 | PIE_InterruptSource_ADCINT_7
                | PIE_InterruptSource_ADCINT_8));
        PIE_forceInt(myPie, PIE_GroupNumber_12, (PIE_InterruptSource_e) PIE_InterruptSource_XINT_3);
