//#############################################################################
//
//  File:   f2802x_examples_ccsv4/hrpwm_prdupdown_sfo_v6/Example_2802xHRPWM_PrdUpDown_SFO_V6.c
//
//  Title:  F2802x Device HRPWM SFO V6 High-Resolution Period (Up-Down Count) example
//
//  Group:          C2000
...
//!          
//!   -# Load the code and add the following watch variables to the watch window:
//!     - UpdateFine
//!     - PeriodFine
//!     - EPwm1Regs.TBPRD
//!     - EPwm1Regs.TBPRDHR   
...
//!   -# Run the code
//!   -# Watch ePWM1A waveform on a Oscillosope
//!   -# In the watch window:
