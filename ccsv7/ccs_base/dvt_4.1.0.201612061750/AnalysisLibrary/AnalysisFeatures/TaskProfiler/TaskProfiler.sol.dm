...
<java version="1.6.0_34" class="java.beans.XMLDecoder"> 
 <object class="com.ti.dvt.datamodel.core.DataModel"> 
  <void property="filePath"> 
   <string>D:\Gforge\trunk\dvt_resources\platform\AnalysisLibrary\AnalysisFeatures\TaskProfiler</string> 
  </void> 
      ...
      <void method="connectOutput"> 
       <object class="com.ti.dvt.datamodel.core.Tap"> 
        ...
        <void method="connectOutput"> 
         ...
         <object class="com.ti.dvt.datamodel.core.Tap"> 
          <void method="connectOutput"> 
           <object class="com.ti.dvt.datamodel.analysis.prototyping.NewBios6TaskProfilerAnalysisBuffer"> 
