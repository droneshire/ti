...
<java version="1.6.0_34" class="java.beans.XMLDecoder"> 
 <object class="com.ti.dvt.datamodel.core.DataModel"> 
  <void property="filePath"> 
   <string>D:\Gforge\trunk\dvt_resources\platform\AnalysisLibrary\AnalysisFeatures\ContextAwareProfile</string> 
  </void> 
      ...
      <void method="connectOutput"> 
       <object class="com.ti.dvt.datamodel.core.Tap"> 
        ...
        <void method="connectOutput"> 
         ...
         <object class="com.ti.dvt.datamodel.core.Tap"> 
          <void method="connectOutput"> 
           <object class="com.ti.dvt.datamodel.analysis.prototyping.NewBios6SysContextAwareProfilerDP"> 
            <void method="connectOutput"> 
             <object class="com.ti.dvt.datamodel.core.Tap"> 
              <void method="connectOutput"> 
               <object class="com.ti.dvt.datamodel.core.Tap"> 
            ...
            <void property="name"> 
             <string>NewBios6SysContextAwareProfilerDP</string> 
            </void> 
           </object> 
          </void> 
          <void property="flow"> 
