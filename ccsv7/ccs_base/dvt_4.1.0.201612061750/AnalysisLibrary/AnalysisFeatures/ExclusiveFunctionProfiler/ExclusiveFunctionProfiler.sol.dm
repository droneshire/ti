...
<java version="1.6.0_34" class="java.beans.XMLDecoder"> 
 <object class="com.ti.dvt.datamodel.core.DataModel"> 
  <void property="filePath"> 
   <string>D:\Gforge\ccstudio5.5\dvt_resources\platform\AnalysisLibrary\AnalysisFeatures\ExclusiveFunctionProfiler</string> 
  </void> 
     ...
     <object class="com.ti.dvt.datamodel.core.Tap"> 
      <void method="connectOutput"> 
       <object class="com.ti.dvt.datamodel.core.Tap"> 
        ...
        <void method="connectOutput"> 
         <int>1</int> 
         <object class="com.ti.dvt.datamodel.core.TraceExclusiveProfiler"> 
          <void property="dataField"> 
           <string>Delta Cycles</string> 
          </void> 
          <void property="dataFieldLabelList"> 
           <string>CPU Cycles </string> 
          </void> 
          <void property="keyField"> 
           <string>Function</string> 
          </void> 
          <void property="name"> 
           <string>Exclusive Function Profiler</string> 
          </void> 
         </object> 
        </void> 
        <void property="flow"> 
