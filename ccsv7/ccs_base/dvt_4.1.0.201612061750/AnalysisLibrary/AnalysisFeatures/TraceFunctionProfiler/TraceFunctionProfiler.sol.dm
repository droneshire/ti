...
<java version="1.6.0_38" class="java.beans.XMLDecoder"> 
 <object class="com.ti.dvt.datamodel.core.DataModel"> 
  <void property="filePath"> 
   <string>C:\Snapshots\svn\dvt\trunk\dvt_resources\platform\AnalysisLibrary\AnalysisFeatures\TraceFunctionProfiler</string> 
  </void> 
     ...
     <object class="com.ti.dvt.datamodel.core.Tap"> 
      <void method="connectOutput"> 
       <object class="com.ti.dvt.datamodel.core.Tap"> 
        ...
        <void method="connectOutput"> 
         <int>2</int> 
         <object class="com.ti.dvt.datamodel.analysis.prototyping2.TraceProfilerPreprocessor"> 
          <void method="connectOutput"> 
           <object class="com.ti.dvt.datamodel.core.Tap"> 
            <void method="connectOutput"> 
             <object class="com.ti.dvt.datamodel.analysis.prototyping2.TraceProfilerBuffer"> 
              <void property="name"> 
            ...
            <void method="connectOutput"> 
             ...
             <object class="com.ti.dvt.datamodel.analysis.prototyping2.TraceProfilerBuffer"> 
              ...
              <void property="reportStyle"> 
               <string>FuncProfileDetails</string> 
              </void> 
             </object> 
            </void> 
            <void method="connectOutput"> 
             ...
             <object class="com.ti.dvt.datamodel.core.Tap"> 
              ...
              <void property="name"> 
               <string>DevTap.1</string> 
              </void> 
              <void property="numInputs"> 
               <int>1</int> 
              </void> 
              <void property="tapFlow"> 
               <boolean>false</boolean> 
              </void> 
             </object> 
            </void> 
          ...
          <void method="connectOutput"> 
           ...
           <object class="com.ti.dvt.datamodel.core.virtualbuffer.VirtualBuffer"> 
            <void property="name"> 
             <string>PerCall</string> 
            </void> 
           </object> 
          </void> 
          <void property="name"> 
           <string>TraceProfilerPreprocessor</string> 
          </void> 
         </object> 
        </void> 
        <void property="flow"> 
