...
<java version="1.6.0_29" class="java.beans.XMLDecoder"> 
 <object class="com.ti.dvt.datamodel.core.DataModel"> 
  <void property="filePath"> 
   <string>C:\scm\svn\branches\ccstudio5.5\dvt_resources\platform\AnalysisLibrary\AnalysisFeatures\MemoryThroughput</string> 
  </void> 
   ...
   <object class="com.ti.dvt.datamodel.core.CSVFileReader"> 
    <void method="connectOutput"> 
     <object class="com.ti.dvt.datamodel.core.Tap"> 
      <void method="connectOutput"> 
       <object class="com.ti.dvt.datamodel.analysis.MemoryThrougtputDP"> 
        <void method="connectOutput"> 
         <object class="com.ti.dvt.datamodel.core.virtualbuffer.VirtualBuffer"> 
          <void property="name"> 
           <string>Memory Throughput</string> 
          </void> 
         </object> 
        </void> 
        <void property="name"> 
         <string>MemoryThroughputDP</string> 
        </void> 
       </object> 
      </void> 
      <void property="flow"> 
