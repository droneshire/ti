	...
	(arglist[ARG_APPLICATION] == undefined) || (arglist[ARG_ETBNAME] == undefined))
{
	script.traceWrite("usage: youscript.js " + ARG_SETUPFILE + " ccssetup_file_name.ccxml " +ARG_TARGETNAME + " trace_target_name " +
					  ...
					  ARG_APPLICATION + " application.out" + ARG_ETBNAME + "EtbProcesorName")
	...
	{
		script.traceWrite("invalid " + ARG_ETBNAME + " argument")
	}
...
if (debugSession.target.isConnected() && debugSessionETB.target.isConnected())
{
    // Load a program
...
if (channelStatus.isRecordingStopped())
{
    ...
    traceChannel.getBinaryTraceData(arglist[ARG_OUTFILE]);
}
