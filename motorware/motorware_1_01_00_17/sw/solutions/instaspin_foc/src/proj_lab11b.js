...
expAdd ("gFlag_enableUpdates", getDecimal());
expAdd ("gFlag_enableOutput", getDecimal());
expAdd ("gFlag_speedStatsReset", getDecimal());
expAdd ("gSpeed_delta_krpm", getQValue(24));
expAdd ("gAdvIndexDelta", getDecimal());
expAdd ("gAlpha", getQValue(24));
